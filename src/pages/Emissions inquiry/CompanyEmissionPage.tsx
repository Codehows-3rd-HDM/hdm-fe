...
const CompanyEmissionPage: React.FC = () => {
  ...
  return (
    <div className="p-8 min-h-screen bg-gray-50 font-sans">
        ...
        <div className="flex flex-col gap-1.5">
          ...
          <div className="relative">
            <select 
              ...
              className="w-32 p-2 pr-8 border border-gray-300 rounded-md text-sm bg-white outline-none cursor-pointer"
            >
      ...
      {/* 2. 가로 스크롤 막대 차트 */}
      {/* ========================== */}
      <div className="w-full bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-10">
