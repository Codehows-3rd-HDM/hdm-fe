...
const KoreaMapChart: React.FC<KoreaMapChartProps> = ({ data: propData, large = false, defaultFitAll = false, theme = 'light' }) => {
  ...
  return (
    <div className={`w-full ${containerHeight} relative rounded-xl shadow-md overflow-hidden flex ${
      theme === 'dark' 
      ...
      <div className="flex-1 relative">
              ...
              geographies.map((geo: any) => {
                ...
                return (
                  <Geography
                    ...
                    style={{
                      default: {
                        fill: value > 0 ? colorScale(value) : (theme === 'dark' ? "#0f172a" : "#F3F4F6"),
        ...
        {/* 범례 */}
        <div className={`absolute bottom-4 right-4 flex flex-col gap-3 p-4 rounded-md shadow-lg text-base ${
          theme === 'dark'
          ...
          <div className="flex items-center gap-3">
            <span className={`w-5 h-5 rounded-sm border ${
              theme === 'dark' 
